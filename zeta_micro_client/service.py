...
class ZetaService(object):
    ...
    base_url_get_account_holder_kyc_token = (
        "account-holder/{account_holder_id}/kyc-token"
    )
    base_url_account_holder_kyc_upgrade = (
        "/account-holder/{account_holder_id}/kyc/upgrade"
    )
    base_url_get_account_holder_kyc_status = (
        "account-holder/{account_holder_id}/kyc-status"
    )
    ...
    base_url_person_payment_instrument_addon = (
        "person/{person_id}/payment-instrument/add"
    )
    ...
    def create_account_holder(self, *args, **kwargs):
        response = self.request.post(
            url=urljoin(self.base_url, self.base_url_create_account_holder),
    ...
    def get_account(self, account_id: str) -> List[Dict]:
        response = self.request.get(
            url=urljoin(
                self.base_url, self.base_url_get_account.format(account_id=account_id)
            ),
            headers=self.base_headers,
            timeout=self.timeout,
        )
    ...
    def create_account(self, *args, **kwargs) -> Dict:
        response = self.request.post(
            url=urljoin(self.base_url, self.base_url_create_account),
            headers=self.base_headers,
            json=kwargs,
            timeout=self.timeout,
        )
    ...
    def get_resource_via_account_id(
        self, account_id: str, *args, **kwargs
    ) -> Tuple[Optional[int], Dict]:
        response = self.request.get(
            url=urljoin(
                self.base_url,
                self.base_url_get_resource_via_account_id.format(account_id=account_id),
            ),
            headers=self.base_headers,
            timeout=self.timeout,
        )
    ...
    def get_resource(
        self, resource_id: str, *args, **kwargs
    ) -> Tuple[Optional[int], Dict]:
        response = self.request.get(
            url=urljoin(
                self.base_url,
    ...
    def create_resource(self, *args, **kwargs) -> Dict:
        response = self.request.post(
            url=urljoin(self.base_url, self.base_url_create_resource),
            headers=self.base_headers,
            json=kwargs,
            timeout=self.timeout,
        )
    ...
    def update_form_factor(
        self, resource_id: str, form_factor_id: str, **kwargs
    ) -> Dict:
        response = self.request.put(
            url=urljoin(
                self.base_url,
                self.base_url_form_factor_id.format(
    ...
    def account_debit(self, **kwargs) -> Dict:
        response = self.request.post(
            url=urljoin(self.base_url, self.base_url_account_debit),
            headers=self.base_headers,
            json=kwargs,
            timeout=self.timeout,
        )
    ...
    def account_purchase(self, **kwargs) -> Dict:
        response = self.request.post(
            url=urljoin(self.base_url, self.base_url_account_purchase),
            headers=self.base_headers,
            json=kwargs,
            timeout=self.timeout,
        )
    ...
    def account_fee(self, **kwargs) -> Dict:
        response = self.request.post(
            url=urljoin(self.base_url, self.base_url_account_fee),
            headers=self.base_headers,
            json=kwargs,
            timeout=self.timeout,
        )
    ...
    def account_transfer(self, **kwargs) -> Dict:
        response = self.request.post(
            url=urljoin(self.base_url, self.base_url_account_intra_transfer),
            headers=self.base_headers,
            json=kwargs,
            timeout=self.timeout,
        )
    ...
    def account_wallet_transfer(self, **kwargs) -> Dict:
        response = self.request.post(
            url=urljoin(self.base_url, self.base_url_account_wallet_transfer),
            headers=self.base_headers,
            json=kwargs,
            timeout=self.timeout,
        )
    ...
    def account_inter_transfer(self, **kwargs) -> Dict:
        response = self.request.post(
            url=urljoin(self.base_url, self.base_url_account_inter_transfer),
            headers=self.base_headers,
            json=kwargs,
            timeout=self.timeout,
        )
    ...
    def get_txn(self, **kwargs) -> Tuple[Optional[int], Dict]:
        response = self.request.get(
            url=urljoin(
                self.base_url, self.base_url_txn_get.format(txn_id=kwargs.get("txn_id"))
            ),
            headers=self.base_headers,
            timeout=self.timeout,
        )
    ...
    def get_balance(self, **kwargs) -> Tuple[Optional[int], Dict]:
        response = self.request.get(
            url=urljoin(
                self.base_url,
                self.base_url_get_account_balance.format(
    ...
    def get_funding_account_balance(self) -> "Tuple[Optional[int], Dict]":
        response = self.request.get(
            url=urljoin(self.base_url, self.base_url_get_funding_account_balance),
            headers=self.base_headers,
            timeout=self.timeout,
        )
        return response
    ...
    def get_credit_limit(self, **kwargs) -> Tuple[Optional[int], Dict]:
        response = self.request.get(
            url=urljoin(
                self.base_url,
                self.base_url_get_account_credit_limit.format(
                    account_id=kwargs.get("account_id")
                ),
            ),
    ...
    def get_debit_limit(self, **kwargs) -> Tuple[Optional[int], Dict]:
        response = self.request.get(
            url=urljoin(
                self.base_url,
                self.base_url_get_account_debit_limit.format(
                    account_id=kwargs.get("account_id")
                ),
            ),
            headers={**self.base_headers, "X-API-VERSION": "v1"},
    ...
    def get_balance_accounts(self, **kwargs) -> Tuple[Optional[int], Dict]:
        response = self.request.get(
            url=urljoin(
                self.base_url,
                self.base_url_get_account_holder_balance.format(
    ...
    def get_account_holder_token(self, **kwargs) -> Tuple[Optional[int], Dict]:
        response = self.request.get(
            url=urljoin(
                self.base_url,
                self.base_url_get_account_holder_token.format(
                    account_holder_id=kwargs.get("account_holder_id")
                ),
            ),
            timeout=self.timeout
    ...
    def get_account_holder_kyc_token(self, **kwargs) -> Tuple[Optional[int], Dict]:
        response = self.request.get(
            url=urljoin(
                self.base_url,
    ...
    def get_account_transactions(
        ...
        response = self.request.get(
            url=urljoin(
                self.base_url,
                self.base_url_account_transactions.format(account_id=account_id),
            ),
            headers=self.base_headers,
            params=params,
            timeout=self.timeout
    ...
    def get_person_account_transactions(
    ...
    def create_card(self, account_id) -> Tuple[Optional[int], Dict]:
        response = self.request.post(
            url=urljoin(
                self.base_url, self.base_url_create_card.format(account_id=account_id)
            ),
            json={},
            headers=self.base_headers,
            timeout=self.timeout
    ...
    def delete_card(self, account_id) -> Tuple[Optional[int], Dict]:
        ...
        response = self.request.post(
            url=urljoin(
                self.base_url, self.base_url_delete_card.format(account_id=account_id)
            ),
            json=req_body,
            headers=self.base_headers,
            timeout=self.timeout
    ...
    def get_card(self, card_id: str) -> Tuple[Optional[int], Dict]:
        response = self.request.get(
            url=urljoin(self.base_url, self.base_url_get_card.format(card_id=card_id)),
            headers=self.base_headers,
            timeout=self.timeout
        )
        return self.process_response(response)
    ...
    def get_card_view(self, card_id: str) -> Tuple[Optional[int], Dict]:
        response = self.request.get(
            url=urljoin(
                self.base_url,
                self.base_url_get_card_view
                + "?card_id={card_id}".format(card_id=card_id),
            ),
            headers=self.base_headers,
            timeout=self.timeout
        )
    ...
    def get_card_set_pin(self, card_id: str) -> Tuple[Optional[int], Dict]:
        response = self.request.get(
            url=urljoin(
                self.base_url,
                self.base_url_get_card_set_pin
                + "?card_id={card_id}".format(card_id=card_id),
            ),
            headers=self.base_headers,
            timeout=self.timeout
    ...
    def get_card_status(self, card_id) -> Tuple[Optional[int], Dict]:
        response = self.request.get(
            url=urljoin(
                self.base_url, self.base_url_get_card_status.format(card_id=card_id)
            ),
            headers=self.base_headers,
            timeout=self.timeout
        )
    ...
    def update_card_status(
        self, card_id, status, reason=None
    ) -> Tuple[Optional[int], Dict]:
        req_body = {
            "card_status": status,
        }
        ...
        response = self.request.post(
            url=urljoin(
                self.base_url, self.base_url_update_card_status.format(card_id=card_id)
            ),
            json=req_body,
            headers=self.base_headers,
            timeout=self.timeout
    ...
    def get_person_account_holder(self, person_id: "UUID"):
        response = self.request.get(
            url=urljoin(
                self.base_url,
                self.base_url_person_account_holder.format(person_id=person_id),
            ),
            headers=self.base_headers,
            timeout=self.timeout
        )
    ...
    def get_person_account(self, person_id: "UUID"):
        response = self.request.get(
            url=urljoin(
                self.base_url, self.base_url_person_account.format(person_id=person_id)
            ),
            headers=self.base_headers,
            timeout=self.timeout
        )
    ...
    def get_person_account_details(self, person_id: "UUID", account_id: str = None):
        response = self.request.get(
            url=urljoin(
                self.base_url,
                self.base_url_person_account_details.format(person_id=person_id),
            ),
    ...
    def get_person_bundle(self, person_id: "UUID"):
        response = self.request.get(
            url=urljoin(
                self.base_url, self.base_url_person_bundle.format(person_id=person_id)
            ),
            headers=self.base_headers,
            timeout=self.timeout
        )
    ...
    def get_person_account_holder_job(self, person_id: "UUID"):
        response = self.request.get(
            url=urljoin(
                self.base_url,
                self.base_url_person_account_holder_job.format(person_id=person_id),
            ),
            headers=self.base_headers,
            timeout=self.timeout
        )
    ...
    def get_person_account_job(self, person_id: "UUID"):
        response = self.request.get(
            url=urljoin(
                self.base_url,
                self.base_url_person_account_job.format(person_id=person_id),
            ),
            headers=self.base_headers,
            timeout=self.timeout
        )
    ...
    def get_person_bundle_job(self, person_id: "UUID"):
        response = self.request.get(
            url=urljoin(
                self.base_url,
                self.base_url_person_bundle_job.format(person_id=person_id),
            ),
            headers=self.base_headers,
            timeout=self.timeout
        )
    ...
    def create_person_account_holder_job(self, person_id: "UUID" = None, **data: dict):
        response = self.request.post(
            ...
            json={
                "attributes": {
                    "kyc": {**data, "dob": data.get("dob").strftime("%Y-%m-%d")},
    ...
    def create_person_payment_instrument_addon(
        ...
        response = self.request.post(
            url=urljoin(
                self.base_url,
                self.base_url_person_payment_instrument_addon.format(
                    person_id=person_id
                ),
            ),
            headers=self.base_headers,
    ...
    def get_card_dispatch(self, card_dispatch_id: str):
        request = self.request.get(
            url=urljoin(
                self.base_url,
                self.base_url_workflow_get_card_dispatch.format(
    ...
    def check_zipcode(self, params):
        request = self.request.get(
            url=urljoin(self.base_url, self.base_url_workflow_check_zipcode),
            headers={**self.base_headers, "X-Api-Version": "v1"},
            params=params,
            timeout=self.timeout
        )
    ...
    def create_txn_policy(self, account_holder_id, card_id, txn_policy_rules):
        ...
        response = self.request.post(
            url=urljoin(self.base_url, base_url_create_txn_policy),
            headers=self.base_headers,
    ...
    def get_txn_policy(self, card_id):
        ...
        response = self.request.get(
            url=urljoin(self.base_url, base_url_get_txn_policy),
            headers=self.base_headers,
            timeout=self.timeout
        )
        return self.process_response(response)
    ...
    def update_txn_policy(self, card_id, txn_policy_list):
        ...
        response = self.request.post(
            url=urljoin(self.base_url, base_url_update_txn_policy),
            headers=self.base_headers,
    ...
    def edit_action_card_dispatch_action(self, card_dispatch_id, action, attributes):
        base_url = self.base_url_workflow_get_card_dispatch_edit_action.format(
            card_dispatch_id=card_dispatch_id
        )
        response = self.request.post(
            url=urljoin(self.base_url, base_url),
    ...
    def perform_payment_instrument_dummy_swap(
        self,
        person_id=None,
        ...
        url_fragment = self.base_url_person_payment_instrument_dummy_swap.format(
            person_id=person_id
        )
        response = self.request.post(
